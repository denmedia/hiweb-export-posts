<?php
	...
	if( !defined( 'HW_EXPORT_POSTS_URL_AJAX' ) )
		...
		define( 'HW_EXPORT_POSTS_URL_AJAX', admin_url('admin-ajax.php') );
	if( !defined( 'HW_EXPORT_POSTS_DIR_TEMPLATE' ) )
		define( 'HW_EXPORT_POSTS_DIR_TEMPLATE', HW_EXPORT_POSTS_DIR . '/views' );
	if( !defined( 'HW_EXPORT_POSTS_DIR_LANGUAGES' ) )
		define( 'HW_EXPORT_POSTS_DIR_LANGUAGES', basename(HW_EXPORT_POSTS_DIR) . '/languages' );
